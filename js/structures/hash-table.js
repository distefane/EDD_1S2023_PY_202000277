    ...
    encriptarXOR(contraseña, clave){
        ...
        recorrer(){
            ...
            this.table.forEach(std => {
                if(std != null){
                    //en el str enviar las filas para una tabla html
                    str += "<tr><td>" + std.carnet + "</td><td>" + std.nombre + "</td><td>" + std.password + "</td></tr>";
                }
            });
            return str;
        }
        ...
        recorrer2(){
            this.table.forEach(std => {
                if(std != null){
                    //en el str enviar nombre y carnet
                    usuario = {nombre: std.nombre, carnet: std.carnet};
                    misUsers.push(usuario);
                }
            });
